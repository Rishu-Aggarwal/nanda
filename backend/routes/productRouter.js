...
import { create, deleteAllProduct, deleteProduct, deleteSigleImage, get, getAll, searchProduct, searchProductByCategoryAndProductName, searchProductsByCategory, update, updateSingleImage, uploadSingleImage } from "../controllers/productController.js";
...
productRouter.get("/search-by-category-and-by-product-name/:search_str",searchProductByCategoryAndProductName);